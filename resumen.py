...
# output_summary = chain.run("hola como estar?")
# wrapped_text = textwrap.fill(
#      docu, width = 100, break_long_words = False, replace_whitespace = False)
...
wrapped_text = textwrap.fill(
     texts, width = 100, break_long_words = False, replace_whitespace = False)
